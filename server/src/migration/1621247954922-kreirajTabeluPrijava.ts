...
export class kreirajTabeluPrijava1621247954922 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `prijava` (`brojPoena` int NOT NULL, `nazivTeme` varchar(255) NOT NULL, `fajl` varchar(255) NOT NULL, `status` varchar(255) NOT NULL, `studentId` int NOT NULL, `seminarskiId` int NOT NULL, `seminarskiPredmet` int NOT NULL, PRIMARY KEY (`studentId`, `seminarskiId`, `seminarskiPredmet`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `prijava` ADD CONSTRAINT `FK_131a90f969fa10d5aa807599a19` FOREIGN KEY (`seminarskiId`, `seminarskiPredmet`) REFERENCES `seminarski`(`id`,`predmetId`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    }
