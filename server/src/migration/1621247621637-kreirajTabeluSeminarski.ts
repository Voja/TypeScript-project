...
export class kreirajTabeluSeminarski1621247621637 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `seminarski` (`id` int NOT NULL AUTO_INCREMENT, `maksBrojPoena` int NOT NULL, `naziv` varchar(255) NOT NULL, `opis` varchar(255) NOT NULL, `mentorId` int NULL, `predmetId` int NOT NULL, PRIMARY KEY (`id`, `predmetId`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `seminarski` ADD CONSTRAINT `FK_5eda3c0581bc110da61c175973d` FOREIGN KEY (`predmetId`) REFERENCES `predmet`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }
